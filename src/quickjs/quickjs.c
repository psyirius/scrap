...
static JSValue JS_CompactBigInt1(JSContext *ctx, JSValue val, BOOL convert_to_safe_integer);
...
static JSValue JS_ToBigDecimalFree(JSContext *ctx, JSValue val, BOOL allow_null_or_undefined);
...
static int JS_CreateProperty(JSContext *ctx, JSObject *p, JSAtom prop, JSValueConst val,
                             JSValueConst getter, JSValueConst setter, int flags);
static int js_string_memcmp(const JSString *p1, const JSString *p2, int len);
static void reset_weak_ref(JSRuntime *rt, JSObject *p);
static JSValue js_array_buffer_constructor3(JSContext *ctx, JSValueConst new_target, uint64_t len, JSClassID class_id,
                                            uint8_t *buf, JSFreeArrayBufferDataFunc *free_func, void *opaque, BOOL alloc_flag);
...
static JSValue js_generator_function_call(JSContext *ctx, JSValueConst func_obj, JSValueConst this_obj,
                                          int argc, JSValueConst *argv, int flags);
static void js_async_function_resolve_finalizer(JSRuntime *rt, JSValue val);
static void js_async_function_resolve_mark(JSRuntime *rt, JSValueConst val, JS_MarkFunc *mark_func);
static JSValue JS_EvalInternal(JSContext *ctx, JSValueConst this_obj, const char *input, size_t input_len,
...
static JSValue js_c_function_data_call(JSContext *ctx, JSValueConst func_obj, JSValueConst this_val,
                                       int argc, JSValueConst *argv, int flags);
...
/* JS Runtime */
#include "./internals/runtime-inl.h"

/* JS parser */
#include "./internals/parser-inl.h"

/* Function bytecode */
#include "./cs/fn-bc-inl.h"

/* Eval functions */
#include "./cs/eval-inl.h"

/* C Module */
#include "./cs/c-module-inl.h"
...
/* Object */
#include "./objects/object-inl.h"

/* Function */
#include "./objects/function-inl.h"

/* Error */
#include "./objects/error-inl.h"

/* Array */
#include "./objects/array-inl.h"

/* Number */
#include "./objects/number-inl.h"

/* Boolean */
#include "./objects/boolean-inl.h"

/* String */
#include "./objects/string-inl.h"

/* Math */
#include "./objects/math-inl.h"

/* RegExp */
#include "./objects/regexp-inl.h"

/* JSON */
#include "./objects/json-inl.h"

/* Reflect */
#include "./objects/reflect-inl.h"

/* Proxy */
#include "./objects/proxy-inl.h"

/* Symbol */
#include "./objects/symbol-inl.h"

/* Set/Map/WeakSet/WeakMap */
#include "./objects/set-map-inl.h"

/* Generator */
#include "./objects/generator-inl.h"

/* Promise */
#include "./objects/promise-inl.h"

/* global object */
#include "./objects/globals-inl.h"

/* Date */
#include "./objects/date-inl.h"

/* Operators */
#include "./objects/operators-inl.h"

/* Big Number */
#include "./objects/bignum-inl.h"

/* Basic Objects */
#include "./objects/basic-objects-inl.h"

/* Typed Arrays */
#include "./objects/typedarrays-inl.h"
