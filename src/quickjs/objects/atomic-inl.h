...
static
void* js_atomics_get_ptr(JSContext *ctx, JSArrayBuffer **pabuf, int *psize_log2, JSClassID *pclass_id,
                                JSValueConst obj, JSValueConst idx_val, int is_waitable) {
    JSObject *p;
    JSTypedArray *ta;
    JSArrayBuffer *abuf;
    void *ptr;
...
static ListNode js_atomics_waiter_list = list_init(js_atomics_waiter_list);
